...
A simple project that plays back and draws recorded Kinectron skeleton data. Created with [p5.js](https://p5js.org/) using the Windows Kinect.

To use live Kinectron data, just change liveData to true and enter your Kinectron IP address. Test it in the p5.js Web Editor [here](http://alpha.editor.p5js.org/lisajamhoury/sketches/SkJm1w58M).

## Demo

<iframe width="550px" height="550px" src="https://editor.p5js.org/lisajamhoury/embed/SkJm1w58M"></iframe>
