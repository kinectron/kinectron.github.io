# Skeleton Images Example 

A simple sketch that draws images for bones in 2D using recorded Kinectron skeleton data. Created with [p5.js](https://p5js.org/) using the Windows Kinect.

To use live Kinectron data, change liveData to true and enter your Kinectron IP address. Test it in the p5.js online editor [here](https://editor.p5js.org/lisajamhoury/sketches/3kjHf9e0s). See [example for Azure Kinect](https://editor.p5js.org/lisajamhoury/sketches/ANHl9dIZ6). 

## Demo

<iframe width="800px" height="900px" src="https://editor.p5js.org/lisajamhoury/embed/3kjHf9e0s"></iframe>
